...
export async function generateMetadata({
  ...
  return {
    title: matchedWork ? `${matchedWork.title} Project` : "Project Not Found | Nick D Studio",
    description: matchedWork ? matchedWork.overview.split(' ').splice(0, 15).join(' ') + "..." : "Project not found at Nick D Studio.",
    alternates: {
...
export default function ProjectView({
  ...
  if (!matchedWork) {
    return <NotFoundComingSoon title="Coming Soon" size="7" size2="30" />;
  }
    ...
    <section>
      <div className='w-full py-10 md:py-16 xl:py-24 max-md:px-3'>
        <div className='w-full flex flex-col items-center justify-center gap-8'>
          <h1 className='text-[8vw] md:text-[7vw] xl:text-9xl text-zinc-400 font-[f1] font-medium leading-[1] text-shadow-2xs text-shadow-zinc-50'>
            {matchedWork.title}
          </h1>
        ...
        <div className='w-full h-fit pt-20 xl:pt-32 flex flex-col gap-5'>
          <div>
            <h3 className='text-[4.2vw] md:text-[1.4em] xl:text-[1.8em] text-zinc-200 font-[f1] font-bold leading-[1]'>
              Project overview
            </h3>
          </div>
        ...
        <div className='w-full flex flex-col pt-[12vw]'>
          <h3 className='text-[5.2vw] md:text-[1.8em] xl:text-[2.4em] font-[f1] font-semibold leading-[1]'>
            Initial concepts
          </h3>
